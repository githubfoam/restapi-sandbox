...
def get_initial_response():
    ...
    message = {
        'apiVersion': 'v1.0',
        'status': '200',
        'message': 'Flask RESTFUL JSON API'
    }
...
def update_user(user_id):
    try:
        ...
        if records_updated.modified_count > 0:
            ...
            # the resource is not available to update
            return "", 404
    except:
        # Error to update the resource
        # Add message for debugging purpose
        return "", 500
